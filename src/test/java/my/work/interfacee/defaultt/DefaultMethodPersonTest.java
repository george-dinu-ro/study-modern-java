...
class DefaultMethodPersonTest {
    ...
    @ParameterizedTest
    @MethodSource("my.work.PersonStorage#getPeopleWithNull")
    void whenCallCompareByNameNullSafe_thenUseNullSafeNameComparator(List<Person> input) {
        ...
        input = new ArrayList<>(input);
        var actual = DefaultMethodPerson.compareByNameNullSafe(input);
